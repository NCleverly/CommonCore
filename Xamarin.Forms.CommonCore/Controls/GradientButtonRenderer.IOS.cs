...
namespace Xamarin.Forms.CommonCore
{
    public class GradientButtonRenderer : ButtonRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
			...
			if (e.PropertyName == GradientButton.ShadowOpacityProperty.PropertyName ||
			   e.PropertyName == GradientButton.ShadowColorProperty.PropertyName ||
			   e.PropertyName == GradientButton.ShadowOffsetProperty.PropertyName ||
			   e.PropertyName == GradientButton.ShadowRadiusProperty.PropertyName)
			{
				SetDropShadow();
				Control.SetNeedsDisplay();
			}
