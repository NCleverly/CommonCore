...
namespace Xamarin.Forms.CommonCore
{
	...
	public partial class FABControlRenderer : ViewRenderer<FABControl, MNFloatingActionButton>
	{
		...
		{
			if (e.PropertyName == FABControl.SizeProperty.PropertyName)
			{
				this.SetSize();
			}
			else if (e.PropertyName == FABControl.ColorNormalProperty.PropertyName ||
					 e.PropertyName == FABControl.ColorPressedProperty.PropertyName)
			{
			...
			else if (e.PropertyName == FABControl.HasShadowProperty.PropertyName)
			{
				this.SetHasShadow();
					 ...
					 e.PropertyName == FABControl.WidthProperty.PropertyName ||
					 e.PropertyName == FABControl.HeightProperty.PropertyName)
			{
				this.SetImage();
			}
			else if (e.PropertyName == FABControl.IsEnabledProperty.PropertyName)
			{
				this.UpdateEnabled();
			}
			else
