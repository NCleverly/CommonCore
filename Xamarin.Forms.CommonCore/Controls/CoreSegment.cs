...
{
    public class CoreSegmentButton : Button { }
    public class CoreSegmentView : ContentView
    {
        public string DisplayTitle { get; set; }
    }
    public class CoreSegment : Grid
    {
        public List<CoreSegmentView> SegmentViews { get; set; } = new List<CoreSegmentView>();
        ...
        public static readonly BindableProperty CornerRadiusProperty =
            BindableProperty.Create("CornerRadius", typeof(double), typeof(CoreSegment), 0.0);
        ...
        public static readonly BindableProperty BorderThicknessProperty =
            BindableProperty.Create("BorderThickness", typeof(int), typeof(CoreSegment), 0);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create("BorderColor", typeof(Color), typeof(CoreSegment), Color.Black);
