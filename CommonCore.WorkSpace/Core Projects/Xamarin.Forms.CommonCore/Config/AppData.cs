...
namespace Xamarin.Forms.CommonCore
{
   ...
   //     public static T GetService<T>(string instanceClass, bool isSingleton = false)
   //     {
			//if (_serviceLocator == null)
				//InitializeServiceLocator();
        ...
        //    if (!Container.IsRegistered<T>())
        //    {
        //        var method = typeof(UnityContainer).GetMethod("RegisterType");
        //        var i = typeof(T);
        //        var t = Type.GetType(instanceClass);
        //        var genericMethod = method.MakeGenericMethod(t, i);

        //        if (isSingleton)
        //            genericMethod.Invoke(Container, new object[] { new ContainerControlledLifetimeManager() });
        //        else
