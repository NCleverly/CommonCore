...
namespace Xamarin.Forms.CommonCore
{
    ...
    public class Popup : ContentView
    {
        ...
        public static readonly BindableProperty HasDropShadowProperty = BindableProperty.Create(nameof(HasDropShadow), typeof(bool), typeof(Popup), default(bool), propertyChanged: OnDropShadowChanged);
        ...
        private static void OnDropShadowChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var popup = (Popup)bindable;
            popup.HasDropShadow = (bool)newValue;
            ((Frame)popup.Content).HasShadow = popup.HasDropShadow;
        }
