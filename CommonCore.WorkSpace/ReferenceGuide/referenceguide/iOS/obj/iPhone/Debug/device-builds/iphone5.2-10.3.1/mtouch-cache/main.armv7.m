...
extern void *mono_aot_module_referenceguide_iOS_info;
...
extern void *mono_aot_module_PushNotification_Plugin_info;
extern void *mono_aot_module_PushNotification_Plugin_Abstractions_info;
...
{
	mono_aot_register_module (mono_aot_module_referenceguide_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_PushNotification_Plugin_info);
	mono_aot_register_module (mono_aot_module_PushNotification_Plugin_Abstractions_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "referenceguide.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
