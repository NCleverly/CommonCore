...
@class Xamarin_Forms_CommonCore_MaterialDesign_FloatTextEntry;
...
@class Xamarin_Forms_CommonCore_GradientButtonRenderer;
@class Xamarin_Forms_Platform_iOS_EntryRenderer;
@class Xamarin_Forms_CommonCore_EntryUnderlineRenderer;
@class Xamarin_Forms_CommonCore_TextAreaRenderer;
@class Xamarin_Forms_Platform_iOS_ViewRenderer;
@class Xamarin_Forms_CommonCore_SegmentControlRenderer;
@class Xamarin_Forms_CommonCore_ContentViewRoundedRenderer;
@class Xamarin_Forms_CommonCore_LoadingOverlay;
@class Xamarin_Forms_CommonCore_UserNotificationCenterDelegate;
@class Xamarin_Forms_Platform_iOS_FormsApplicationDelegate;
@class AppDelegate;
@class Xamarin_Forms_CommonCore_MaterialDesign_FABControlRenderer;
@class Xamarin_Forms_CommonCore_MaterialDesign_MNFloatingActionButton;
